...
import com.example.bilhar.databinding.ActivityPoolBinding
...
class Pool : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editor.putBoolean("pool_visited", true)
        editor.apply()
            ...
            imageView_Bola7.setOnTouchListener { view, event ->
                ...
                when (event.action) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        dY_Bola7 = view.y - event.rawY + offsetY
                    }
                    MotionEvent.ACTION_MOVE -> {
    ...
    private fun saveBitmap(bitmap: Bitmap): File? {
        ...
        return try {
            val file = File(storageDir, "Pool.png")
